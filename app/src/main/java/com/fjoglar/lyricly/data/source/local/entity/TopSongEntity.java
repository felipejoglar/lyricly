...
/**
 * Model class for a top rated chart song.
 */
@Entity(tableName = "top_songs")
public class TopSongEntity implements Song {
    ...
    public TopSongEntity(String napsterId,
                         int albumIndex,
                         int playbackSeconds,
                         String name,
                         String artistId,
    ...
    public boolean equals(Object o) {
        ...
        TopSongEntity that = (TopSongEntity) o;
        return id == that.id &&
