...
/**
 * Model class for a user favorite song.
 */
@Entity(tableName = "favorite_songs")
public class FavoriteSongEntity implements Song {
     ...
     */
    public FavoriteSongEntity(int id,
                              String napsterId,
                              int albumIndex,
                              int playbackSeconds,
                              String name,
    ...
    @Ignore
    public FavoriteSongEntity(String napsterId,
                              int albumIndex,
                              int playbackSeconds,
                              String name,
                              String artistId,
    ...
    public boolean equals(Object o) {
        ...
        FavoriteSongEntity that = (FavoriteSongEntity) o;
        return id == that.id &&
