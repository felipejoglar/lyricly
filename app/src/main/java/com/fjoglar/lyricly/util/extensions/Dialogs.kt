...
fun showAlertDialogOk(
    ...
    with(MaterialAlertDialogBuilder(context, R.style.ThemeOverlay_MaterialComponents_MaterialAlertDialog_Centered)) {
        setTitle(titleResourceId?.let { context.getString(it) })
